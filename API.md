...
### Hello <a name="cdk-common.Hello"></a>

#### Initializers <a name="cdk-common.Hello.Initializer"></a>

```typescript
import { Hello } from 'cdk-common'

new Hello(name: string)
```

##### `name`<sup>Required</sup> <a name="cdk-common.Hello.parameter.name"></a>
...
##### `name`<sup>Required</sup> <a name="cdk-common.Hello.property.name"></a>
