...
export enum AWSManagedPolicies {
  ...
  AWSQUICK_SETUP_PATCH_POLICY_BASELINE_ACCESS = 'AWSQuickSetupPatchPolicyBaselineAccess',
  AWSSYSTEMS_MANAGER_ENABLE_CONFIG_RECORDING_EXECUTION_POLICY = 'AWSSystemsManagerEnableConfigRecordingExecutionPolicy',
  AWSSYSTEMS_MANAGER_ENABLE_EXPLORER_EXECUTION_POLICY = 'AWSSystemsManagerEnableExplorerExecutionPolicy',
  AWSQUICK_SETUP_DEV_OPS_GURU_PERMISSIONS_BOUNDARY = 'AWSQuickSetupDevOpsGuruPermissionsBoundary',
  AWSQUICK_SETUP_PATCH_POLICY_PERMISSIONS_BOUNDARY = 'AWSQuickSetupPatchPolicyPermissionsBoundary',
  AWSQUICK_SETUP_SSM_HOST_MGMT_PERMISSIONS_BOUNDARY = 'AWSQuickSetupSSMHostMgmtPermissionsBoundary',
  AWSQUICK_SETUP_DISTRIBUTOR_PERMISSIONS_BOUNDARY = 'AWSQuickSetupDistributorPermissionsBoundary',
  AWSQUICK_SETUP_CFGC_PACKS_PERMISSIONS_BOUNDARY = 'AWSQuickSetupCFGCPacksPermissionsBoundary',
  ...
  AMAZON_ECS_INFRASTRUCTURE_ROLE_POLICY_FOR_VPC_LATTICE = 'AmazonECSInfrastructureRolePolicyForVpcLattice',
  AWSQUICK_SETUP_ENABLE_DHMC_EXECUTION_POLICY = 'AWSQuickSetupEnableDHMCExecutionPolicy',
  AWSQUICK_SETUP_MANAGED_INSTANCE_PROFILE_EXECUTION_POLICY = 'AWSQuickSetupManagedInstanceProfileExecutionPolicy',
  AWSQUICK_SETUP_SSM_LIFECYCLE_MANAGEMENT_EXECUTION_POLICY = 'AWSQuickSetupSSMLifecycleManagementExecutionPolicy',
  AWSQUICK_SETUP_SSM_DEPLOYMENT_S3_BUCKET_ROLE_POLICY = 'AWSQuickSetupSSMDeploymentS3BucketRolePolicy',
  AWSQUICK_SETUP_ENABLE_AREX_EXECUTION_POLICY = 'AWSQuickSetupEnableAREXExecutionPolicy',
  AWSQUICK_SETUP_SSM_MANAGE_RESOURCES_EXECUTION_POLICY = 'AWSQuickSetupSSMManageResourcesExecutionPolicy',
  AWSQUICK_SETUP_SSM_DEPLOYMENT_ROLE_POLICY = 'AWSQuickSetupSSMDeploymentRolePolicy',
  AWS_SSM_AUTOMATION_DIAGNOSISBUCKETPOLICY = 'AWS-SSM-Automation-DiagnosisBucketPolicy',
  AWS_SSM_DIAGNOSISAUTOMATION_ADMINISTRATIONROLEPOLICY = 'AWS-SSM-DiagnosisAutomation-AdministrationRolePolicy',
  AWS_SSM_DIAGNOSISAUTOMATION_EXECUTIONROLEPOLICY = 'AWS-SSM-DiagnosisAutomation-ExecutionRolePolicy',
  AWS_SSM_DIAGNOSISAUTOMATION_OPERATIONALACCOUNTADMINISTRATIONROLEPOLICY = 'AWS-SSM-DiagnosisAutomation-OperationalAccountAdministrationRolePolicy',
  ...
  AWSSECURITY_INCIDENT_RESPONSE_SERVICE_ROLE_POLICY = 'aws-service-role/AWSSecurityIncidentResponseServiceRolePolicy',
  AWSSECURITY_INCIDENT_RESPONSE_TRIAGE_SERVICE_ROLE_POLICY = 'aws-service-role/AWSSecurityIncidentResponseTriageServiceRolePolicy',
  CLOUD_WATCH_OPEN_SEARCH_DASHBOARDS_FULL_ACCESS = 'CloudWatchOpenSearchDashboardsFullAccess',
  CLOUD_WATCH_OPEN_SEARCH_DASHBOARD_ACCESS = 'CloudWatchOpenSearchDashboardAccess',
  CLOUD_WATCH_NETWORK_FLOW_MONITOR_SERVICE_ROLE_POLICY = 'aws-service-role/CloudWatchNetworkFlowMonitorServiceRolePolicy',
  CLOUD_WATCH_NETWORK_FLOW_MONITOR_AGENT_PUBLISH_POLICY = 'CloudWatchNetworkFlowMonitorAgentPublishPolicy',
  CLOUD_WATCH_NETWORK_FLOW_MONITOR_TOPOLOGY_SERVICE_ROLE_POLICY = 'aws-service-role/CloudWatchNetworkFlowMonitorTopologyServiceRolePolicy',
  ...
  AMAZON_SAGE_MAKER_MODEL_CUSTOMIZATION_CORE_ACCESS = 'AmazonSageMakerModelCustomizationCoreAccess',
  AWSRESILIENCE_HUB_SERVICE_ROLE_POLICY = 'aws-service-role/AWSResilienceHubServiceRolePolicy',
  AWSAPPLICATION_MIGRATION_F_SX_PROXY_POLICY = 'service-role/AWSApplicationMigrationFSxProxyPolicy',
  AWSAPPLICATION_MIGRATION_F_SX_PROXY_VPC_POLICY = 'service-role/AWSApplicationMigrationFSxProxyVPCPolicy',
  AMAZON_SAGE_MAKER_JOB_RUNTIME_ACCESS = 'AmazonSageMakerJobRuntimeAccess',
  AMAZON_SAGE_MAKER_JOB_FULL_ACCESS = 'AmazonSageMakerJobFullAccess',
  AWSQUICK_SETUP_PATCH_POLICY_TAG_MANAGEMENT_EXECUTION_POLICY = 'AWSQuickSetupPatchPolicyTagManagementExecutionPolicy',
  AWSQUICK_SETUP_PATCH_POLICY_LAMBDA_EXECUTION_POLICY = 'AWSQuickSetupPatchPolicyLambdaExecutionPolicy',
  FIN_OPS_AGENT_OPERATOR_POLICY = 'FinOpsAgentOperatorPolicy',
  FIN_OPS_AGENT_AGENT_POLICY = 'FinOpsAgentAgentPolicy',
  EC2_IMAGE_BUILDER_EXECUTION_POLICY = 'EC2ImageBuilderExecutionPolicy',
  ...
  AWSELASTIC_BEANSTALK_EKS_OBSERVABILITY = 'AWSElasticBeanstalkEKSObservability',
  AWSELASTIC_BEANSTALK_EKS_TAGGING = 'AWSElasticBeanstalkEKSTagging',
  AWSELASTIC_BEANSTALK_EKS_IMAGE_BUILD = 'AWSElasticBeanstalkEKSImageBuild',
  DBMOD_VIRTUAL_SOURCE = 'DBModVirtualSource',
  AWSTRANSFORM_REVENUE_ATTRIBUTION_POLICY = 'AWSTransformRevenueAttributionPolicy',
};